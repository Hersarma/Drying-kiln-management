  ...
  <div class="md:px-8 md:flex justify-between w-full text-center bg-gradient-to-r from-blue_gray-900 via-blue_gray-800 to-blue_gray-900">
    ...
    <div class="flex justify-between">
      ...
      <div class="flex px-4 md:px-12 py-4 md:py-8">
        <button type="button"
        class="open_modal_create_incoming transition ease-out duration-500 transform hover:scale-110 py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-teal-400 hover:bg-teal-500 focus:outline-none shadow-xl">
          ...
          <tr>
            <td colspan="8" class="overflow-hidden">
              <div class="flex justify-center mt-5 md:mt-0">
                <button type="button" 
                class="open_modal_create_incoming transition ease-out duration-500 transform hover:scale-110 py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md font-bold text-white bg-teal-400 hover:bg-teal-500 focus:outline-none shadow-xl">
                Dodaj novi ulaz
                </button>
              </div>
            </td>
