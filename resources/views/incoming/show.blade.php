...
<section class="md:px-12">
  ...
  <div class="flex mx-auto">
    <button type="button" class="toggle_modal_edit_incoming transition ease-out duration-500 transform hover:scale-110 mx-auto mt-10 text-white bg-teal-400 border-0 py-2 px-4 focus:outline-none hover:bg-teal-500 rounded text-base shadow-xl"><i
