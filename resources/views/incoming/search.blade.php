...
<p onclick="window.location = '{{ route('incoming.show',$item )}}'" class="w-1/5 cursor-pointer py-3 text-center text-sm text-teal-400 group-hover:text-teal-600">
...
@foreach($incoming as $item)
      <div onclick="window.location = '{{ route('incoming.show',$item )}}'" class="cursor-pointer border-b border-teal-400 rounded-xl px-2 py-1 my-5 text-sm shadow-lg bg-gray-800">
