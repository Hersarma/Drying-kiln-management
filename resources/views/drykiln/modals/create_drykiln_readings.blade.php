        ...
        <form method="post" action="{{ route('create_drykiln_reading') }}" class="py-8 px-8 md:px-0">
          ...
          <div class="md:flex justify-between items-center">
            <div class="md:px-4 md:w-1/2">
              ...
              <div class="md:w-2/3">
              <input class="comma appearance-none bg-gradient-to-r from-blue_gray-800 via-blue_gray-700 to-blue_gray-800 rounded-xl border-l-4 border-gray-400 w-full py-3 px-4 text-gray-200 leading-tight focus:outline-none focus:border-turquoise-light focus:shadow-xl shadow-lg"
             ...
             @if($drykiln->dry_kiln_config->probe_2_status)
              ...
              <div class="md:w-2/3">
              <input class="comma ppearance-none bg-gradient-to-r from-blue_gray-800 via-blue_gray-700 to-blue_gray-800 rounded-xl border-l-4 border-gray-400 w-full py-3 px-4 text-gray-200 leading-tight focus:outline-none focus:border-turquoise-light focus:shadow-xl shadow-lg"
          ...
          <div class="flex justify-between mt-12 px-8">
            <button type="button"
            class="close_modal_create_drykiln_readings py-2 w-1/3 transition ease-out duration-500 transform hover:scale-110 border border-transparent text-sm leading-5 font-medium rounded-md text-black bg-gray-300 hover:bg-gray-400 focus:outline-none">
            Otkaži
            </button>
            <button type="submit"
