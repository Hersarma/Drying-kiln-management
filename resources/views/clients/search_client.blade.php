...
<tr
  ...
  <td onclick="window.location = '{{ route('clients.show',$client )}}'" class="hidden md:table-cell px-4 py-3 text-left md:text-center text-sm text-gray-200 group-hover:text-teal-600">{{ \Illuminate\Support\Str::limit(ucfirst($client->email) ,20,'...')}}</td>
  ...
  <td  class="px-4 py-3 text-left md:text-right"><a href="{{ route('clients.show',$client )}}"
