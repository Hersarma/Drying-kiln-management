  ...
  <div class="md:px-8 md:flex justify-between w-full text-center">
    <div class="px-8 py-8">
      ...
      <div class="flex items-center text-gray-600 px-4 md:px-12 py-4 md:py-8">
        ...
        <input type="search" name="search_clients" placeholder="Pretraga po imenu"
    ...
    <form method="post" action="{{ route('delete_checked_clients') }}">
      ...
      <div>
        <div class="flex justify-between items-center px-4 border-b border-gray-700">
          ...
          <p class="sm:w-1/2 md:w-1/2 lg:w-1/5 py-3 tracking-wider text-gray-100 text-sm text-center">
            Ime
          </p>
          <p class="sm:w-1/2 md:w-1/2 lg:w-1/5 py-3 tracking-wider text-gray-100 text-sm text-center">
            Email
