          ...
          <tr>
            <td colspan="8" class="overflow-hidden">
              <div class="flex justify-center mt-5 md:mt-0">
                <button type="button" 
                class="toggle_modal_create_outgoing transition ease-out duration-500 transform hover:scale-110 py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md font-bold text-white bg-teal-400 hover:bg-teal-500 focus:outline-none shadow-xl">
                Dodaj novi izlaz
                </button>
              </div>
            </td>
