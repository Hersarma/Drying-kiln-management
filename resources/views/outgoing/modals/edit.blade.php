			...
			<div class="w-full max-w-5xl mx-auto">
				<form method="post" action="{{ route('outgoing.update', $outgoing) }}" class="py-8 px-8 md:px-0">
					...
					<div class="flex justify-between py-4">
						<button type="button"
						class="close_modal_edit_outgoing py-2 w-1/3 transition ease-out duration-500 transform hover:scale-110 py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md text-black bg-gray-300 hover:bg-gray-400 focus:outline-none">
						Otkaži
						</button>
						<button type="submit"
