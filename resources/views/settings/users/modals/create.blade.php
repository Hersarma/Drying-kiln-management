<div class="modal_create_user hidden fixed z-20 inset-0 overflow-y-auto">
        ...
        <form method="post" action="#" class="py-8 px-8 md:px-0">
          ...
          <div class="md:flex md:items-center mb-6 text-gray-200 text-opacity-80 focus-within:text-opacity-100">
            ...
            <div class="md:w-2/3">
              ...
              <p class="text-red-500 text-sm italic mt-4">
                {{ $errors->create_user->first('last_name') }}
              </p>
            </div>
          </div>
          <div class="md:flex md:items-center mb-6 text-gray-200 text-opacity-80 focus-within:text-opacity-100">
          ...
          <div class="flex justify-between mt-12">
            <button type="button"
            class="toggle_modal_create_user py-2 w-1/3 transition ease-out duration-500 transform hover:scale-110 border border-transparent text-sm leading-5 font-medium rounded-md text-black bg-gray-300 hover:bg-gray-400 focus:outline-none">
            Otkaži
            </button>
            <button type="submit"
