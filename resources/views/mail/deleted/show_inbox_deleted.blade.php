...
<div class="w-full md:w-2/3 mx-auto mt-10">
	<div class="border-t border-b border-turquoise-light py-4">
		...
		<div class="flex items-center px-4">
			<p class="cursor-pointer text-green-400 px-2">
				<a href="{{ route('mail_inbox_restore_deleted',$mail )}}"
  				class="text-green-400 hover:text-green-600"><i class="transition ease-out duration-500 transform hover:scale-110 fa fa-undo fa-lg"></i></a>
			</p>
			<p class="cursor-pointer get_route_id text-red-600 hover:text-red-700 px-2">
    			<i class="transition ease-out duration-500 transform hover:scale-110 fas fa-trash fa-lg">
    			</i>
    			<span class="hidden">{{route('mail_permanently_delete', $mail)}}</span>
    		</p>
		</div>
	</div>
