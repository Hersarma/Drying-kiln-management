<nav class="py-2">
  <div class="flex justify-center">
    ...
    class="mx-3 px-3 py-2 text-sm font-medium leading-5 {{ Request::is('mail/deleted/*') ? 'border-b-2 border-turquoise-light text-gray-200' : 'text-gray-500 hover:text-gray-200 border-b-2 border-gray-500 hover:border-turquoise-light focus:outline-none transition duration-150 ease-in-out' }}">
    ...
    class="mx-3 mr-6 px-3 py-2 text-sm font-medium leading-5 {{ Request::is('mail/sent', 'mail/sent/*') ? 'border-b-2 border-turquoise-light text-gray-200' : 'text-gray-500 hover:text-gray-200 border-b-2 border-gray-500 hover:border-turquoise-light focus:outline-none transition duration-150 ease-in-out' }}">
    ...
    class="mx-3 mr-6 px-3 py-2 text-sm font-medium leading-5 {{ Request::is('mail/new_mail') ? 'border-b-2 border-turquoise-light text-gray-200' : 'text-gray-500 hover:text-gray-200 border-b-2 border-gray-500 hover:border-turquoise-light focus:outline-none transition duration-150 ease-in-out' }}">
